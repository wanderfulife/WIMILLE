...
const pageTitle = ref('WIMILLE'); // Browser tab title
...
const customWelcomeMessage = ref(`Bonjour, pour mieux connaître les usages du pôle gare de Wimille-Wimereux,<br><br> La communauté d'agglomération du Boulonnais souhaiterait en savoir plus sur votre déplacement en cours.<br><br> Acceptez-vous de répondre à quelques questions ?`); // HTML welcome message
